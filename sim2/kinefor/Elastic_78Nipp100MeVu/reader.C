...
*/
{
  ...
  TH2F *hh1 = new TH2F("hh1", "Elastic 78Ni(p,p) @ 100 MeV/nucleon", 2, mlimitA, MlimitA, 2, mlimitE, MlimitE);
  ...
  TH2F *hh2 = new TH2F("hh2","Elastic 78Ni(p,p) @ 100 MeV/nucleon -> proton", 2, smallestA_1, greatestA_1, 2, smallestE_1, greatestE_1);
  ...
  TH2F *hh3 = new TH2F("hh3", "Elastic 78Ni(p,p) @ 100 MeV/nucleon -> 78 Ni", 2, smallestA_2, greatestA_2, 2, smallestE_2, greatestE_2);
  ...
  TH2F *hh4 = new TH2F("hh4", "Elastic 78Ni(p,p) @ 100 MeV/nucleon E1 vs E2", 2, smallestE_1, greatestE_1, 2, smallestE_2, greatestE_2);
  ...
  TH2F *hh5 = new TH2F("hh5", "Elastic 78Ni(p,p) @ 100 MeV/nucleon A1 vs A2", 2, smallestA_1, greatestA_1, 2, smallestA_2, greatestA_2);
