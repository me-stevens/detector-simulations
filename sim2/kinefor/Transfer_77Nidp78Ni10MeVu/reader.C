...
*/
{
  ...
  TH2F *hh1 = new TH2F("hh1", "Transfer 77Ni(d, p)78Ni @ 10 MeV/nucleon", 2, mlimitA, MlimitA, 2, mlimitE, MlimitE);
  ...
  TCanvas* c2 = new TCanvas("LabEvsLabAngle_Proton", "Lab Energy vs Lab Angle -> Proton", 100, 100, 1000, 700);
  c2->SetFillColor(10);
  c2->SetBorderSize(2);
  c2->SetFrameFillColor(0);

  TH2F *hh2 = new TH2F("hh2", "Transfer 77Ni(d, p)78Ni @ 10 MeV/nucleon -> proton", 2, smallestA_1, greatestA_1, 2, smallestE_1, greatestE_1);
  ...
  gr02->SetLineColor(1);
  gr02->SetTitle("proton");
  gr02->SetMarkerColor(2);
  gr02->SetMarkerStyle(21);
  gr02->SetMarkerSize(0.8);
  gr02->Draw("P SAME");

  TCanvas* c3 = new TCanvas("LabEvsLabAngle_78Ni", "Lab Energy vs Lab Angle -> 78Ni", 100, 100, 1000, 700);
  c3->SetFillColor(10);
  c3->SetBorderSize(2);
  c3->SetFrameFillColor(0);

  TH2F *hh3 = new TH2F("hh3", "Transfer 77Ni(d, p)78Ni @ 10 MeV/nucleon -> 78 Ni", 2, smallestA_2, greatestA_2, 2, smallestE_2, greatestE_2);
  ...
  TCanvas* c4 = new TCanvas("LabEpVsLabE78Ni", "Lab Proton Energy vs Lab 78Ni Energy", 100, 100, 1000, 700);
  c4->SetFillColor(10);
  c4->SetBorderSize(2);
  c4->SetFrameFillColor(0);

  TH2F *hh4 = new TH2F("hh4", "Transfer 77Ni(d, p)78Ni @ 10 MeV/nucleon E1 vs E2", 2, smallestE_1, greatestE_1, 2, smallestE_2, greatestE_2);
  hh4->SetXTitle("Proton lab Energy (MeV)");
  hh4->SetYTitle("78Ni lab Energy (MeV)");
  ...
  TCanvas* c5 = new TCanvas("LabAnglepVsLabAngle78Ni", "Lab Proton Angle vs Lab 78Ni Angle", 100, 100, 1000, 700);
  c5->SetFillColor(10);
  c5->SetBorderSize(2);
  c5->SetFrameFillColor(0);

  TH2F *hh5 = new TH2F("hh5", "Transfer 77Ni(d, p)78Ni @ 10 MeV/nucleon A1 vs A2", 2, smallestA_1, greatestA_1, 2, smallestA_2, greatestA_2);
  hh5->SetXTitle("Proton lab Angle (deg)");
  hh5->SetYTitle("78Ni lab Angle (deg)");
